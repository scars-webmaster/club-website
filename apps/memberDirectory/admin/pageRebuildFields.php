	...
	*/
	...
	$schema = array(   
		'memberInfo' => array(   
			...
			'suffix' => array('appgini' => 'VARCHAR(5) '),
			'middle' => array('appgini' => 'VARCHAR(40) '),
			'memberDate' => array('appgini' => 'VARCHAR(40) '),
			'homePhone' => array('appgini' => 'VARCHAR(40) '),
			'workPhone' => array('appgini' => 'VARCHAR(40) '),
			'mobilePhone' => array('appgini' => 'VARCHAR(40) '),
			'emailPreferred' => array('appgini' => 'VARCHAR(40) '),
			'emailOther' => array('appgini' => 'VARCHAR(40) '),
			'addressLine1' => array('appgini' => 'VARCHAR(40) '),
			'addressLine2' => array('appgini' => 'VARCHAR(40) '),
			'city' => array('appgini' => 'VARCHAR(40) '),
			'state' => array('appgini' => 'VARCHAR(40) '),
			'zip' => array('appgini' => 'VARCHAR(40) ')
		)
	);
