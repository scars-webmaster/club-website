...
<!-- InstanceEndEditable --></div>    <!-- end menubar - Standard Menu --> 
  ...
  <div id="LayoutDiv6"><!-- InstanceBeginEditable name="EditArticleRegion" --><h3>PICTURES</h3>
    <div>
       <div id="photograph">
   <h3>Rick KM4ZMW - Winner of the 2017 AM Broadcasting DX Contest</h3> 
	<p><a href="pics.php" title="Return to Index">Return to Pictures Index</a></p>   
<h4 class="title">Rick KM4ZMW recieves trophy from John W4TXA (2016 winner)</h4>
<img src="pics/AMcontestWinner2017.jpg" title="Rick KM4ZMW" alt="Rick KM4ZMW" /><br><br>
