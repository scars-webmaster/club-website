...
<!-- InstanceEndEditable --></div>    <!-- end menubar - Standard Menu --> 
  ...
  <div id="LayoutDiv6"><!-- InstanceBeginEditable name="EditArticleRegion" --><h3>PICTURES</h3>
    <div>
       <div id="photograph">
           <h3>Antenna raising party (Dec 21, 2017) at K4NPZ's QTH</br>
               in East Point, GA.
           </h3> 
   <p><a href="pics.php" title="Return to Index">Return to Pictures Index</a></p>
   <p>K4ELI along with KM4ZMW, KN4FVA, KF4UOS install a 2M/70cm base station antenna at K4NPZ's QTH. (K4ELI photo)</p>
   <img src="pics/K4NPZ_antenna_party/IMG_20171221.jpg" alt=""> <br><br>
