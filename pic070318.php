...
<!-- InstanceEndEditable --></div>    <!-- end menubar - Standard Menu --> 
  ...
  <div id="LayoutDiv6"><!-- InstanceBeginEditable name="EditArticleRegion" --><h3>PICTURES</h3>
    <div>
       <div id="photograph">
           <h3>ARRL Elmer Award presentation's
           </h3>
           
   <p><a href="pics.php" title="Return to Index">Return to Pictures Index</a></p>
   <p>Its a Double header! Congratulations to Chuck (K4CGA) and Steve (K4ELI). Both received "two" ARRL Elmer appreciation awards during our 3 July 2018 Silver Comet Amateur Radio Society meeting.  Way to go Guys! </p>
   <img src="pics/20180703_ELMERS.jpg" alt=""> <br><br>
