...
<!-- InstanceEndEditable --></div>    <!-- end menubar - Standard Menu --> 
  ...
  <div id="LayoutDiv6"><!-- InstanceBeginEditable name="EditArticleRegion" --><h3>PICTURES</h3>
    <div>
       <div id="photograph">
   <h3>Ron West - WB3ILX , GAARES Ham Of The Year 2015</h3> 
	<p><a href="pics.php" title="Return to Index">Return to Pictures Index</a></p>
   <h4 class="title">Ron-WB3ILX and David-AG4ZR</h4>
   <img src="pics/ronwb3ilx.jpg" alt="Ron-WB3ILX"> <br><br>    
   
   <p>All pics will be available in higher quality file format for limited time after publication. Contact webmaster at silvercometars dot com, include folder and label above the picture.</p>
	<p><a href="pics.php" title="Return to Index">Return to Pictures Index</a></p>    
   </div><br><br>
