...
<!-- InstanceEndEditable --></div>    <!-- end menubar - Standard Menu --> 
  ...
  <div id="LayoutDiv6"><!-- InstanceBeginEditable name="EditArticleRegion" --><h3>PICTURES</h3>
    <div>
       <div id="photograph">
           <h3>Radio Santa Claus recorded on the 146.955 repeater (Dec 15, 2017)
           </h3> 
   <p><a href="pics.php" title="Return to Index">Return to Pictures Index</a></p>
   
   <img src="pics/RadioSantaClaus2017/RadioSantaClaus.png" alt="">
   <audio controls autoplay>
       <source src="pics/RadioSantaClaus2017/SCARS_Santa_20171215.wav" type="audio/wav">
       <source src="pics/RadioSantaClaus2017/SCARS Santa 20171215.mp3" type="audio/mpeg"
