...
if ( !is_product() && !is_singular() ) :
	...
	$display_title = apply_filters( 'hootubix_wooloop_meta_display_title', true, 'plural' );
...
elseif ( is_product() ) :
	...
	add_filter( 'hootubix_loop_meta_display_title', 'hootubix_hide_loop_meta_woo_product' );
