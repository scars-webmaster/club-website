...
$TotalSoftFontGCount = array("Abadi MT Condensed Light", "Aharoni", "Aldhabi", "Amaranth, sans-serif", "Andalus", "Angsana New", "AngsanaUPC", "Anton, sans-serif", "Aparajita", "Arabic Typesetting", "Arial", "Arial Black", "Batang", "BatangChe", "Browallia New", "BrowalliaUPC", "Calibri", "Calibri Light", "Calisto MT", "Cambria", "Candara", "Century Gothic", "Comic Sans MS", "Consolas", "Constantia", "Copperplate Gothic", "Copperplate Gothic Light", "Battambang, cursive", "Baumans, cursive", "Bungee Shade, cursive", "Butcherman, cursive", "Cabin, sans-serif", "Cabin Sketch, cursive",  "Cairo, sans-serif", "Damion, cursive", "DilleniaUPC", "DaunPenh", "Eagle Lake, cursive", "East Sea Dokdo, cursive", "Fira Sans Condensed, sans-serif", "Fira Sans Extra Condensed, sans-serif", "FreesiaUPC", "Gafata,  sans-serif", "Gabriola", "Jacques Francois, serif",  "Headland One, serif", "Katibeh, cursive", "KaiTi", "Microsoft Yi Baiti", "Monsieur La Doulaise, cursive", "Mr De Haviland, cursive", "Nova Script, cursive", "Nova Square, cursive", "Nyala", "Odor Mean Chey, cursive", "Offside, cursive", "Old Standard TT, serif", "Oldenburg, cursive", "Oxygen, sans-serif", "Oxygen Mono, monospace",  "Princess Sofia, cursive", "Prociono, serif", "Prompt, sans-serif", "Prosto One, cursive", "Proza Libre, sans-serif",  "Quicksand, sans-serif", "Quintessential, cursive",  "Qwigley, cursive",  "Raavi", "Racing Sans One, cursive", "Radley, serif", "Rajdhani, sans-serif", "Rakkas, cursive", "Raleway, sans-serif", "Raleway Dots, cursive", "Ramabhadra, sans-serif", "Ramaraja, serif", "Rosarivo, serif", "Revalia, cursive",  "Shruti", "Siemreap, cursive", "Sigmar One, cursive", "Signika, sans-serif", "Signika Negative, sans-serif", "SimHei", "SimKai", "Simonetta, cursive", "Tahoma", "Tajawal, sans-serif", "Tangerine, cursive", "Taprom, cursive", "Tauri, sans-serif", "Taviraj, serif", "Teko, sans-serif", "Telex, sans-serif", "Tenali Ramakrishna, sans-serif", "Tenor Sans, sans-serif", "Text Me One, sans-serif", "The Girl Next Door, cursive", "Tienne, serif", "Tillana, cursive", "Times New Roman", "Timmana, sans-serif", "Tinos, serif", "Titan One, cursive", "Vijaya");
