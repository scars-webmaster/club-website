    ...
    $name = 'ts_filtr';
		...
		if($Total_Soft_Cal=='true'){
			...
			if($TotalSoftCal_Type[0]->TotalSoftCal_Type=='Event Calendar'){
				...
				$fonts_google    ='https://fonts.googleapis.com/css?family='.$this->$name($TotalSoftCal_Par[0]->TotalSoftCal_HFF).'|'.$this->$name($TotalSoftCal_Par[0]->TotalSoftCal_WFF).'|'.$this->$name($TotalSoftCal_Par[0]->TotalSoftCal_DFF).'';
				...
				$fonts_google    ='https://fonts.googleapis.com/css?family='.$this->$name($TotalSoftCal_Par[0]->TotalSoftCal2_MFF).'|'.$this->$name($TotalSoftCal_Par[0]->TotalSoftCal2_WFF).'|'.$this->$name($TotalSoftCal_Par[0]->TotalSoftCal2_Ev_HFF).'';
				...
				$fonts_google    ='https://fonts.googleapis.com/css?family='.$this->$name($TotalSoftCal_Par[0]->TotalSoftCal3_H_FF).'|'.$this->$name($TotalSoftCal_Par[0]->TotalSoftCal3_WD_FF).'|'.$this->$name($TotalSoftCal_Par[0]->TotalSoftCal3_Ev_FF).'';
				...
				$fonts_google    ='https://fonts.googleapis.com/css?family='.$this->$name($TotalSoftCal_Par[0]->TotalSoftCal4_11).'|'.$this->$name($TotalSoftCal_Par[0]->TotalSoftCal3_WD_FF).'|'.$this->$name($TotalSoftCal_Par[0]->TotalSoftCal3_Ev_FF).'';
			}
		}else{
      ...
      <link href="<?php echo $fonts_google; ?>" rel="stylesheet">
		<?php
		if($TotalSoftCal_Type[0]->TotalSoftCal_Type=='Event Calendar'){ ?>
        <style type="text/css">
            ...
            <?php echo $TotalSoftCal_Par[0]->TotalSoftCal_HCol;?>     ;*/
            }
            ...
            .monthly-day-blank<?php echo $Total_Soft_Cal;?> {
            ...
            <?php echo $TotalSoftCal_Par[0]->TotalSoftCal_NumPos;?>: 2 px;
            ...
            .monthly-today<?php echo $Total_Soft_Cal;?> {
            ...
            @media (min-width: 400px) {
                .monthly-day-number<?php echo $Total_Soft_Cal;?> {
                    top: 5px;
                <?php echo $TotalSoftCal_Par[0]->TotalSoftCal_NumPos;?>: 5 px;
                    font-size: 13px;
                }
            }
            ...
            @media screen and (max-width: 400px) {
                .TotalSoftcalEvent_1_Media<?php echo $Total_Soft_Cal;?>, .TotalSoftcalEvent_1_Mediadiv<?php echo $Total_Soft_Cal;?> {
                    width: 100% !important;
                }
            }
        ...
        <div class="page">
            <input type="text" style="display:none;" id="TotalSoftCal_ArrowLeft"
                   value="<?php echo $TotalSoftCal_Par[0]->TotalSoftCal_ArrowLeft; ?>">
            <input type="text" style="display:none;" id="TotalSoftCal_ArrowRight"
                   value="<?php echo $TotalSoftCal_Par[0]->TotalSoftCal_ArrowRight; ?>">
            <input type="text" style="display:none;" id="totalsoftcal_<?php echo $Total_Soft_Cal; ?>_1"
                   value="<?php echo $Total_Soft_Cal; ?>">
            <div style="width:99.96%; max-width:<?php echo $TotalSoftCal_Par[0]->TotalSoftCal_MW; ?>px; display:block; margin: 10px auto 40px;">
                <div class="monthly monthly<?php echo $Total_Soft_Cal; ?>"
                     id="totalsoftcal_<?php echo $Total_Soft_Cal; ?>"></div>
            </div>
        </div>
        <!-- JS ======================================================= -->
                        ...
                        function setMonthly(m, y) {
                            ...
                            if (options.mode == 'event') {
                                $.get('' + options.xmlUrl + '', function (d) {
																	...
																	?>
                                    Event_Calendar('<?php echo $TotalSoftEventData;?>', uniqueId, setMonth, setYear, dayQty);
																	<?php } ?>
                                }).fail(function () {
        ...
        <style type="text/css">
            ...
            #calendar_<?php echo $Total_Soft_Cal;?> .c-event-list::-webkit-scrollbar {
                width: 9px;
            }

            /* Track */
            #calendar_<?php echo $Total_Soft_Cal;?> .c-event-list::-webkit-scrollbar-track {
                background: none;
            }
            ...
            #calendar_<?php echo $Total_Soft_Cal;?> .c-event-list::-webkit-scrollbar-thumb:hover {
                background: #cecece;
            }
        ...
        <script type="text/javascript">
            jQuery(document).ready(function () {
                jQuery('#calendar_<?php echo $Total_Soft_Cal;?>').eCalendar({
                    ...
                    textArrows: {
                        previous: '<i class="totalsoft totalsoft-<?php echo $TotalSoftCal_Par[0]->TotalSoftCal2_ArrType;?>-left"></i>',
                        next: '<i class="totalsoft totalsoft-<?php echo $TotalSoftCal_Par[0]->TotalSoftCal2_ArrType;?>-right"></i>'
                    },
                    ...
                    events: [
											...
											?>
                        {
                            ...
                            datetime: new Date(<?php echo $TotalSoftCal_EvStartDateSplit[0];?>, <?php echo $TotalSoftCal_EvStartDateSplit[1]-1;?>, <?php echo $TotalSoftCal_EvStartDateSplit[2];?>),
                            endtime: '<?php echo $Total_Soft_CalEvents[$i]->TotalSoftCal_EvEndTime?>',
                            eventurl: "<?php echo $Total_Soft_CalEvents[$i]->TotalSoftCal_EvURL?>",
                            eventnewtab: "<?php echo $Total_Soft_CalEvents[$i]->TotalSoftCal_EvURLNewTab?>",
                            enddateyear: "<?php echo $TotalSoftCal_EvEndDateSplit[0];?>",
                            enddatemonth: "<?php echo $TotalSoftCal_EvEndDateSplit[1]-1;?>",
                            enddateday: "<?php echo $TotalSoftCal_EvEndDateSplit[2];?>",
                            timeformat: '<?php echo $TotalSoftCal_Part[0]->TotalSoftCal_04;?>',
                            dateformat: '<?php echo $TotalSoftCal_Part[0]->TotalSoftCal_05;?>',
                            enddatereal: "<?php echo $Total_Soft_CalEvents[$i]->TotalSoftCal_EvEndDate;?>",
                            eventimg: "<?php echo $Total_Soft_CalEventDesc[0]->TotalSoftCal_EvImg;?>",
                            eventvid: "<?php echo $Total_Soft_CalEventDesc[0]->TotalSoftCal_EvVid_Src;?>",
                            eventvidpos: "<?php echo $TotalSoftCal_Part[0]->TotalSoftCal_03;?>",
                            realstarttime: "<?php echo $Total_Soft_CalEvents[$i]->TotalSoftCal_EvStartTime;?>",
                            eventrec: "<?php echo $Total_Soft_CalEventRec[0]->TotalSoftCal_EvRec;?>",
                            eventshowdate: "<?php echo $TotalSoftCal_Part[0]->TotalSoftCal_06;?>"
                        },
											<?php }?>
                    ],
        ...
        <style type="text/css">
            ...
            <?php if(strrpos($TotalSoftCal_Par[0]->TotalSoftCal3_BBC,"0)") < 1){ ?> border: 1px solid<?php echo $TotalSoftCal_Par[0]->TotalSoftCal3_BBC;?>;
            <?php }?>
            }
            ...
            #custom-month_<?php echo $Total_Soft_Cal;?> {
                background-color: transparent !important;
                padding: 0px !important;
                width: 100% !important;
            }

            #custom-year_<?php echo $Total_Soft_Cal;?> {
                background-color: transparent !important;
            }

            #custom-month_<?php echo $Total_Soft_Cal;?>:after {
                display: none !important;
            }

            #custom-year_<?php echo $Total_Soft_Cal;?>:after {
                display: none !important;
            }
        </style>
                ...
                <div class="custom-calendar-wrap">
                    <div id="custom-inner_<?php echo $Total_Soft_Cal; ?>" class="custom-inner">
                        <div class="custom-header clearfix custom-header_<?php echo $Total_Soft_Cal; ?>">
                            <nav>
                                <i id="custom-prev_<?php echo $Total_Soft_Cal; ?>"
                                   class="totalsoft totalsoft-<?php echo $TotalSoftCal_Par[0]->TotalSoftCal3_Arr_Type; ?>-left "></i>
                                <i id="custom-next_<?php echo $Total_Soft_Cal; ?>"
                                   class="totalsoft totalsoft-<?php echo $TotalSoftCal_Par[0]->TotalSoftCal3_Arr_Type; ?>-right"></i>
                            </nav>
                        ...
                        <div id="calendar_<?php echo $Total_Soft_Cal; ?>"
                             class="fc-calendar-container fc-calendar-container_<?php echo $Total_Soft_Cal; ?>"></div>
                    </div>
                </div>
            </section>
        </div><!-- /container -->
        ...
        <script type="text/javascript">
            jQuery(function () {
                ...
                function showEvents($contentEl, dateProperties) {
                    ...
                    var
                    $events = jQuery('<div id="custom-content-reveal_<?php echo $Total_Soft_Cal;?>" class="custom-content-reveal"><h4>' + dateProperties.year + ' ' + dateProperties.monthname + ' ' + dateProperties.day + '</h4></div>'),
        ...
        <style type="text/css">
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_07 == 'color'){ ?> background-color: <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_08;?> !important;
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_07 == 'gradient1'){ ?> background: <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_08;?>;
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_07 == 'gradient2'){ ?> background: <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_08;?>;
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_07 == 'gradient3'){ ?> background: <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_08;?>;
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_07 == 'gradient4'){ ?> background: -webkit-linear-gradient(<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_08;?>, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_09;?>, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_08;?>);
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_07 == 'gradient5'){ ?> background: -webkit-linear-gradient(left, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_08;?>, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_09;?>, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_08;?>);
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_07 == 'gradient6'){ ?> background: -webkit-repeating-linear-gradient(<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_08;?>, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_09;?>, 10%, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_08;?> 20%);
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_07 == 'gradient7'){ ?> background: -webkit-repeating-linear-gradient(45deg,<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_08;?>,<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_09;?> 7%,<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_08;?> 10%);
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_07 == 'gradient8'){ ?> background: -webkit-repeating-linear-gradient(190deg,<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_08;?>,<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_09;?> 7%,<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_08;?> 10%);
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_07 == 'gradient9'){ ?> background: -webkit-repeating-linear-gradient(90deg,<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_08;?>,<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_09;?> 7%,<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_08;?> 10%);
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_07 == 'gradient10'){ ?> background: <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_08;?>;
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_07 == 'gradient11'){ ?> background: <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_08;?>;
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_07 == 'gradient12'){ ?> background: -webkit-radial-gradient(circle, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_08;?>, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_09;?>, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_08;?>);
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_07 == 'gradient13'){ ?> background: -webkit-repeating-radial-gradient(<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_08;?>, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_09;?> 10%, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_08;?> 15%);
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_22 == 'color'){ ?> background-color: <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_23;?> !important;
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_22 == 'gradient1'){ ?> background: <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_23;?>;
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_22 == 'gradient2'){ ?> background: <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_23;?>;
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_22 == 'gradient3'){ ?> background: <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_23;?>;
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_22 == 'gradient4'){ ?> background: -webkit-linear-gradient(<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_23;?>, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_24;?>, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_23;?>);
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_22 == 'gradient5'){ ?> background: -webkit-linear-gradient(left, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_23;?>, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_24;?>, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_23;?>);
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_22 == 'gradient6'){ ?> background: -webkit-repeating-linear-gradient(<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_23;?>, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_24;?>, 10%, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_23;?> 20%);
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_22 == 'gradient7'){ ?> background: -webkit-repeating-linear-gradient(45deg,<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_23;?>,<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_24;?> 7%,<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_23;?> 10%);
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_22 == 'gradient8'){ ?> background: -webkit-repeating-linear-gradient(190deg,<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_23;?>,<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_24;?> 7%,<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_23;?> 10%);
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_22 == 'gradient9'){ ?> background: -webkit-repeating-linear-gradient(90deg,<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_23;?>,<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_24;?> 7%,<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_23;?> 10%);
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_22 == 'gradient10'){ ?> background: <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_23;?>;
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_22 == 'gradient11'){ ?> background: <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_23;?>;
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_22 == 'gradient12'){ ?> background: -webkit-radial-gradient(circle, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_23;?>, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_24;?>, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_23;?>);
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_22 == 'gradient13'){ ?> background: -webkit-repeating-radial-gradient(<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_23;?>, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_24;?> 10%, <?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_23;?> 15%);
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_39 == 'color'){ ?> background-color: <?php echo $TotalSoftCal_Part[0]->TotalSoftCal_01;?> !important;
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_39 == 'gradient1'){ ?> background: <?php echo $TotalSoftCal_Part[0]->TotalSoftCal_01;?>;
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_39 == 'gradient2'){ ?> background: <?php echo $TotalSoftCal_Part[0]->TotalSoftCal_01;?>;
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_39 == 'gradient3'){ ?> background: <?php echo $TotalSoftCal_Part[0]->TotalSoftCal_01;?>;
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_39 == 'gradient4'){ ?> background: -webkit-linear-gradient(<?php echo $TotalSoftCal_Part[0]->TotalSoftCal_01;?>, <?php echo $TotalSoftCal_Part[0]->TotalSoftCal_02;?>, <?php echo $TotalSoftCal_Part[0]->TotalSoftCal_01;?>);
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_39 == 'gradient5'){ ?> background: -webkit-linear-gradient(left, <?php echo $TotalSoftCal_Part[0]->TotalSoftCal_01;?>, <?php echo $TotalSoftCal_Part[0]->TotalSoftCal_02;?>, <?php echo $TotalSoftCal_Part[0]->TotalSoftCal_01;?>);
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_39 == 'gradient6'){ ?> background: -moz-repeating-linear-gradient(<?php echo $TotalSoftCal_Part[0]->TotalSoftCal_01;?>, <?php echo $TotalSoftCal_Part[0]->TotalSoftCal_02;?>, 10%, <?php echo $TotalSoftCal_Part[0]->TotalSoftCal_01;?> 20%);
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_39 == 'gradient7'){ ?> background: -webkit-repeating-linear-gradient(45deg,<?php echo $TotalSoftCal_Part[0]->TotalSoftCal_01;?>,<?php echo $TotalSoftCal_Part[0]->TotalSoftCal_02;?> 7%,<?php echo $TotalSoftCal_Part[0]->TotalSoftCal_01;?> 10%);
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_39 == 'gradient8'){ ?> background: -webkit-repeating-linear-gradient(190deg,<?php echo $TotalSoftCal_Part[0]->TotalSoftCal_01;?>,<?php echo $TotalSoftCal_Part[0]->TotalSoftCal_02;?> 7%,<?php echo $TotalSoftCal_Part[0]->TotalSoftCal_01;?> 10%);
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_39 == 'gradient9'){ ?> background: -webkit-repeating-linear-gradient(90deg,<?php echo $TotalSoftCal_Part[0]->TotalSoftCal_01;?>,<?php echo $TotalSoftCal_Part[0]->TotalSoftCal_02;?> 7%,<?php echo $TotalSoftCal_Part[0]->TotalSoftCal_01;?> 10%);
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_39 == 'gradient10'){ ?> background: <?php echo $TotalSoftCal_Part[0]->TotalSoftCal_01;?>;
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_39 == 'gradient11'){ ?> background: <?php echo $TotalSoftCal_Part[0]->TotalSoftCal_01;?>;
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_39 == 'gradient12'){ ?> background: -webkit-radial-gradient(circle, <?php echo $TotalSoftCal_Part[0]->TotalSoftCal_01;?>, <?php echo $TotalSoftCal_Part[0]->TotalSoftCal_02;?>, <?php echo $TotalSoftCal_Part[0]->TotalSoftCal_01;?>);
            ...
            <?php }else if($TotalSoftCal_Par[0]->TotalSoftCal4_39 == 'gradient13'){ ?> background: -webkit-repeating-radial-gradient(<?php echo $TotalSoftCal_Part[0]->TotalSoftCal_01;?>, <?php echo $TotalSoftCal_Part[0]->TotalSoftCal_02;?> 10%, <?php echo $TotalSoftCal_Part[0]->TotalSoftCal_01;?> 15%);
            ...
            .TimleLIne_TS_Cal_<?php echo $Total_Soft_Cal;?> .TimleLIne_TS_Cal_wrap .TimleLIne_TS_Cal_event h3:after {
                display: none !important;
            }
        ...
        <div class="TimleLIne_TS_Cal TimleLIne_TS_Cal_<?php echo $Total_Soft_Cal; ?>">
            <input type="text" style="display: none;" id="TimleLIne_TS_Cal_HDF_<?php echo $Total_Soft_Cal; ?>"
                   value="<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_12; ?>">
            <input type="text" style="display: none;" id="TimleLIne_TS_Cal_YAT_<?php echo $Total_Soft_Cal; ?>"
                   value="<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_14; ?>">
            <input type="text" style="display: none;" id="TimleLIne_TS_Cal_BAT_<?php echo $Total_Soft_Cal; ?>"
                   value="<?php echo $TotalSoftCal_Par[0]->TotalSoftCal4_32; ?>">
        ...
        <script type="text/javascript">
            jQuery(document).ready(function () {
                setTimeout(function () {
                    jQuery('.TimleLIne_TS_Cal_<?php echo $Total_Soft_Cal;?>').jflatTimeline({
                        scroll: '1',
                        calid: '<?php echo $Total_Soft_Cal;?>',
                        month: new Array('<?php echo __('January','Total-Soft-Calendar');?>', '<?php echo __('February','Total-Soft-Calendar');?>', '<?php echo __('March','Total-Soft-Calendar');?>', '<?php echo __('April','Total-Soft-Calendar');?>', '<?php echo __('May','Total-Soft-Calendar');?>', '<?php echo __('June','Total-Soft-Calendar');?>', '<?php echo __('July','Total-Soft-Calendar');?>', '<?php echo __('August','Total-Soft-Calendar');?>', '<?php echo __('September','Total-Soft-Calendar');?>', '<?php echo __('October','Total-Soft-Calendar');?>', '<?php echo __('November','Total-Soft-Calendar');?>', '<?php echo __('December','Total-Soft-Calendar');?>')
                    });
                }, 300)
            })
        </script>
