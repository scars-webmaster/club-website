...
<html class=""><!-- InstanceBegin template="/Templates/TemplateLayout-SCARS-062315.dwt" codeOutsideHTMLIsLocked="false" -->
    ...
    <head>
        ...
        <title>Silver Comet ARS: Home</title>
    ...
    <body>
        <div class="gridContainer clearfix">
            ...
            <!-- menubar HOME	-->
            <div id="LayoutDiv4"><!-- InstanceBeginEditable name="EditNavRegion" --><ul>
            ...
            </div>    <!-- end menubar HOME -->  

            <div id="LayoutDiv5">&nbsp;</div>

            
            <div><img src="images/welcome.gif" alt="welcome"></div>
                <script>
                    function myFunction() {
                        location.reload();
                    }
...
<div class="lp-article-heading">                
            <div style="font-size:140%; font-color:green">
...
<!--                      <div class="floating-box-alert">
                ...
                <Table align="center" BORDER=0 CELLSPACING=0 CELLPADDING=0>
                  ...
                  <TD>
                    ...
                    <TABLE BORDER=0 CELLSPACING=0 CELLPADDING=0><TR>
                            <TD ALIGN=center WIDTH=150><STRONG>Solar X-rays: <BR>Geomagnetic Field: </STRONG></TD>
                            <TD><TABLE BORDER=0 CELLSPACING=0 CELLPADDING=0><TR>
                                        <TD ALIGN=CENTER><CENTER><A HREF="http://www.n3kl.org/sun/noaa.html" target="_blank"><IMG WIDTH=121 
                  ...
                  <TD>
                    ...
                    <a href="http://www.hamqsl.com/solar.html" title="Click to add Solar-Terrestrial Data to your website!"><img src="http://www.hamqsl.com/solar101vhfpic.php?image=random"></a>
                    <p style="text-align:center ; padding-right:3em"><button onclick="myFunction()">Click here to refresh Solar table data</button></div>   
                    </div>
            ...
            <div id="LayoutDiv9">	
                ...
                <!-- InstanceBeginEditable name="EditFooterRegion" -->  
                <!-- <div align="center">
                  DO NOT MODIFY THE FOLLOWING CODE 
                     <p class="footer"><span>VISITORS: </span><a href="http://www.reliablecounter.com" target="_blank"><img src="http://www.reliablecounter.com/count.php?page=www.silvercometars.com&digit=style/odometers/1/&reloads=1" alt="" title="" border="0"></a><br /><a href="http://www.curinglight.com" target="_blank" style="font-family: Geneva, Arial; font-size: 9px; color: #330010; text-decoration: none;">Link</a><br />
                  </p></div>    InstanceEndEditable Footer  -->
            </div>
